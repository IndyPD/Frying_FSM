...
''' Recipe FSM related '''
MOVE_TO_FRY_MOTION_TIME = 60
MOVE_FROM_FRY_MOTION_TIME = 60
...
CONFIG_FILE = "projects/bulk_frying/configs/frying_recipe.json"
...
class DryRecipeFsmState(OpState):
    INACTIVE = INACTIVE_STATE
    NO_MENU             = 1
    COOKING_READY       = 2
    FRY                 = 3
...
class DryRecipeFsmEvent(OpEvent):
    NONE = NONE_EVENT
...
class WetRecipeFsmState(OpState):
    INACTIVE = INACTIVE_STATE
    WAIT_PUTIN = 1
    PUTIN = 2
    WAIT_MENU = 3
...
class WetRecipeFsmEvent(OpEvent):
    NONE = NONE_EVENT
    START_PUTIN = 1
    ASSIGN_MENU = 2
    SHAKE_DONE = 3
...
class ContyCommand(IntEnum):
    ...
    HOME = 100
    MOVE_BASKET_TO_FRYER      = 310
    MOVE_BASKET_FROM_FRYER    = 310
    SHAKE_BASKET              = 350
    SHIFT_BASKET              = 400
