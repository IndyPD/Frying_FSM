...
class GlobalConfig:
    ...
    def initialize(self, project_name):
        ...
        config_dir = os.path.join(repo_root, "projects", project_name, "configs")
        self._app_config_path = os.path.join(config_dir, "app_config.json")
        self._config_path = os.path.join(config_dir, "configs.json")
