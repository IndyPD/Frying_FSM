...
class DryMoveToFryStrategy(Strategy):
    def prepare(self, context: DryRecipeContext, **kwargs):
        ...
        bb.set(f"ui/state/fryer{context.fryer_index}/is_cooking", True)  # Set lock for UI
...
class DryFinishStrategy(Strategy):
    def prepare(self, context: DryRecipeContext, **kwargs):
        ...
        bb.set(f"ui/state/fryer{context.fryer_index}/is_cooking", False) # Release lock for UI
