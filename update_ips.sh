...
# 파일 경로
APP_CONFIG_PATH="projects/bulk_frying/configs/app_config.json"
CONFIGS_PATH="projects/bulk_frying/configs/configs.json"
DIO_CONFIG_PATH="projects/bulk_frying/configs/dio_config.json"
